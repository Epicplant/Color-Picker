...
public class CircleColorPickerView extends ColorPickerView {
    ...
    public CircleColorPickerView(Context context, AttributeSet attrs) {
        ...
        // TODO: Initialize variables as necessary (such as Paint objects)
...
/*
        The height and width of the of the dial determined by the bounding box of the CircleColorPickerView.
                The the radius of the actual ColorPicker interactor is the half the smaller of the width or the height of that
        that bounding box.
        */
    ...
    protected EssentialGeometry essentialGeometry(MotionEvent event) {
        ...
        //check to see if event is occurring inside of the circle (not bounding box) or not
        //if not set Essential Geometry to enumerator to outside
